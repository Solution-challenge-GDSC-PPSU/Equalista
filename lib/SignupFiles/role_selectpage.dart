          ...
          child: Container(
            decoration: const BoxDecoration(
              image: DecorationImage(
                image: AssetImage(
                    'assets/rainbow.png'), // replace with your image path
                fit: BoxFit.fill,
              ),
            ),
            child: Column(
              ...
              children: [
                Padding(
                  padding:
                      EdgeInsets.only(top: height * 0.1, right: 8, left: 8),
                      ...
                      child: InkWell(
                        ...
                        child: Container(
                          decoration: const BoxDecoration(
                            ...
                            borderRadius:
                                BorderRadius.all(Radius.circular(10.1)),
                          ),
                          width: 150,
                          height: 150,
                          child: Column(
                              ...
                              children: const [
                                ...
                                Text(
                                  "Join",
                                  style: TextStyle(
                                      fontSize: 20, color: Color(0xff495057)),
                                )
                              ]),
                        ),
                      ),
